...
val Double.volts get() = ElectricalPotential(this)
val Number.volts get() = toDouble().volts

val ElectricalPotential.inVolts get() = value
val ElectricalPotential.inPercentOutput get() = this / BATTERY_VOLTAGE
