...
val Number.joules get() = Energy(this.toDouble())

val Force.inJoules : Double get() = value

val Force.inYottajoules : Double get() = value.yotta
val Force.inZetajoules : Double get() = value.zeta
val Force.inExajoules : Double get() = value.exa
val Force.inPetajoules : Double get() = value.peta
val Force.inTerajoules : Double get() = value.tera
val Force.inGigajoules : Double get() = value.giga
val Force.inMegajoules : Double get() = value.mega
val Force.inKilojoules : Double get() = value.kilo
val Force.inHectojoules : Double get() = value.hecto
val Force.inDecajoules : Double get() = value.deca
val Force.inDecijoules : Double get() = value.deci
val Force.inCentijoules : Double get() = value.centi
val Force.inMillijoules : Double get() = value.milli
val Force.inMicrojoules : Double get() = value.micro
val Force.inNanojoules : Double get() = value.nano
val Force.inPicojoules : Double get() = value.pico
val Force.inFemtojoules : Double get() = value.femto
val Force.inAttojoules : Double get() = value.atto
val Force.inZeptojoules : Double get() = value.zepto
val Force.inYoctojoules : Double get() = value.yocto
